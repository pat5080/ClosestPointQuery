...
const std::vector<Vector3f> Mesh::getMeshPoints() const
{
    return vertices;
}

const std::vector<Vector3i> Mesh::getMeshFaces() const
{
    return faces;
}

void Mesh::setMeshPoints(std::vector<Vector3f> &p)
{
...
void Mesh::setMeshFaces(const std::vector<Vector3i> &f)
{
    faces = f;
...
void Mesh::read_ply_file(const std::string & filepath, const bool preload_into_memory)
{
    std::cout << "........................................................................\n";
        ...
        try
        {
            ...
            // Example One: converting to your own application types
                ...
                std::vector<Vector3i> face(faces->count);
                std::memcpy(face.data(), faces->buffer.get(), numFacesBytes);
